...
OPENSSL_INCLUDE_PATH=D:/deps/openssl-1.0.1j/include
OPENSSL_LIB_PATH=D:/deps/openssl-1.0.1j
...
contains(Moonshot_NEED_QT_PLUGINS, 1) {
    DEFINES += Moonshot_NEED_QT_PLUGINS
...
HEADERS += src/qt/Moonshotgui.h \
    ...
    src/crypto/sha256.h \
    src/crypto/sha512.h \
    src/qt/incptoolbutton.h

SOURCES += src/qt/Moonshot.cpp src/qt/Moonshotgui.cpp \
...
# also add new translations to src/qt/Moonshot.qrc under translations/
TRANSLATIONS = $$files(src/qt/locale/inception_*.ts)
...
OTHER_FILES += \
    doc/*.rst doc/*.txt doc/README README.md res/Moonshot.rc
...
windows:RC_FILE = src/qt/res/Moonshot.rc
